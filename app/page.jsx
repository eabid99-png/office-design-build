...
export default function Home() {
  ...
  return (
    <main style={{ fontFamily: "Arial, sans-serif", margin: 0, color: "#111" }}>
      ...
      {/* HERO */}
      <section id="home" style={{ height: "78vh", position: "relative", overflow: "hidden" }}>
        <div style={{
          position: "absolute",
          inset: 0,
        ...
        <div style={{
          ...
          <p style={{ fontSize: 22, marginTop: 24, lineHeight: 1.5 }}>
      ...
      {/* ABOUT */}
      <section style={{ padding: "75px 6%" }}>
        <h2 style={{ fontSize: 38 }}>Workspace Design & Build Specialists</h2>
        <p style={{ maxWidth: 950, lineHeight: 1.8, fontSize: 18 }}>
          We provide complete workspace design and build services across London, from planning and refurbishment through to finishes, furniture and handover. Our focus is simple: create professional, practical and high-quality commercial interiors that help your business work better.
        </p>
      </section>

      {/* SERVICES */}
      <section id="services" style={{ padding: "80px 6%", background: "#f5f5f5" }}>
        <h2 style={{ fontSize: 38 }}>Our Services</h2>
      ...
      <section id="project" style={{ padding: "80px 6%" }}>
        <h2 style={{ fontSize: 38 }}>1 Whittington Avenue, London</h2>
        <p style={{ maxWidth: 850, lineHeight: 1.7, fontSize: 18 }}>
      ...
      <section id="process" style={{ padding: "90px 6%", background: "#05080c", color: "white" }}>
        <p style={{ color: "#c79a46", letterSpacing: 2, fontWeight: "bold" }}>
          HOW WE WORK
        </p>
        ...
        <div style={{
          ...
          {[
            ["01", "Consultation", "We meet with you to understand your workspace needs, budget and timeline. Our team provides expert advice to ensure the project starts on the right track.", "/slide1.jpg"],
            ["02", "Design", "We create a tailored design including layout, materials, finishes and lighting to maximise both functionality and visual impact.", "/slide2.jpg"],
            ["03", "Build", "Our skilled team delivers the full fit out with precision, managing every stage from construction to installation while maintaining high standards.", "/slide3.jpg"],
            ["04", "Completion", "We carry out final checks, ensure quality finishes and hand over a fully completed workspace ready for immediate use.", "/slide4.jpg"],
      ...
      <section id="contact" style={{ padding: "80px 6%", background: "#f5f5f5" }}>
        <div style={{
          ...
          <h2 style={{ textAlign: "center", fontSize: 36 }}>Contact Us</h2>
